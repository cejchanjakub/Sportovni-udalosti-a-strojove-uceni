# src/inference/services/sot_home_service.py
...
from src.inference.model_loader import load_sot_home_model, load_sot_away_model
...
class SOTHomeResult:
    mapped: Dict[str, str]
    swapped: bool
    mean: float  # očekávaný počet SOT REQUEST-HOME
    lines: Dict[str, Any]
    matched_row: Dict[str, Any]


class SOTHomeService:
    """
    Service pro střely na bránu domácího týmu (request-home).

    Logika swapped (stejně jako CardsHomeService):
