# src/inference/services/shots_total_service.py
...
class ShotsTotalService:
    ...
    def __init__(self) -> None:
        if self.__class__._model is None:
            model, feat_order, alpha = load_sot_total_model()
