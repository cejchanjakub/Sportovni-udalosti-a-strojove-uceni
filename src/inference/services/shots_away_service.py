# src/inference/services/sot_away_service.py
...
class SOTAwayResult:
    mapped: Dict[str, str]
    swapped: bool
    mean: float  # očekávaný počet SOT REQUEST-AWAY
    lines: Dict[str, Any]
    matched_row: Dict[str, Any]


class SOTAwayService:
    """
    Service pro střely na bránu hostujícího týmu (request-away).
